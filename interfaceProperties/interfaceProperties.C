...
:
	...
	rho1_("rho", dimDensity,
		transportPropertiesDict_.subDict( transportPropertiesDict_.get<wordList>("phases")[0] )
	),
	rho2_("rho", dimDensity,
		transportPropertiesDict_.subDict( transportPropertiesDict_.get<wordList>("phases")[1] )
	),
...
bool Foam::interfaceProperties::read()
{
    ...
    transportPropertiesDict_.subDict( transportPropertiesDict_.get<wordList>("phases")[0] ).lookup("rho") >> rho1_; // KVA
    transportPropertiesDict_.subDict( transportPropertiesDict_.get<wordList>("phases")[1] ).lookup("rho") >> rho2_; // KVA
